...
<head>
	...
	<title>APP Page | KR - Focus on smart furniture</title>
</head>
<body>
				...
				<div class="main-content">
					<div class="content-heading clearfix">
						<div class="heading-left">
							<h1 class="page-title">全部APP</h1>
<!--							<p class="page-subtitle">
								<span class="text-danger">您创建的免费APP太多了!</span>&nbsp;&nbsp;&nbsp;<a href="#"><i class="fa fa-plus-circle"></i> 升级方案</a></p>-->
						</div>
						<ul class="breadcrumb">
							<li><a href="#"><i class="fa fa-home"></i>首页</a></li>
							<li class="active">全部APP</li>
						</ul>
					</div>
					<div class="container-fluid">
						<div class="row">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="textAppName" placeholder="请输入APP的名称">
						</div>
						<div class="input-group">
							<span class="input-group-addon">应用描述</span>
							<input type="text" class="form-control" id="textAppDesc" placeholder="请输入关于这个APP的描述信息">
						</div>
						<br>
						<div class="input-group">
							<span class="input-group-addon">作者姓名</span>
							<input type="text" class="form-control" id="textAppAuthorName" readonly>
						</div>
						<div class="input-group">
							<span class="input-group-addon">作者邮箱</span>
							<input type="text" class="form-control" id="textAppAuthorEmail" readonly>
						</div>
						<div class="input-group">
							<span class="input-group-addon">作者头像</span>
					...
					<div class="modal-footer">
						<span id="error-text" class="has-error" ></span>
						<button type="button" class="btn btn-default"
								data-dismiss="modal">取消
						</button>
						<button type="button" class="btn btn-primary" id="btnCreateApp">
							创建
						</button>
					</div>
				</div><!-- /.modal-content -->
